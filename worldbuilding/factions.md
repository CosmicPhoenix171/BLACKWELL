...
| Division | Role |
|----------|------|
| Acquisitions | "Recruiting" Aether-capable individuals |
| R&D | Aether-tech weapons, implants, systems |
...
1. Identified through mandatory screening
2. Flagged in classified database
3. Approached by recruiters
4. Drafted — refusal is not an option

**You don't volunteer for AETHCOM. AETHCOM takes you.**

---

## The Divine (God's Forces)
...
- **Role**: God's enforcers, messengers, and soldiers
- **Weakness**: Bound by divine law; vulnerable to Aether weapons
- **Status**: Being hunted by AETHCOM for batteries

### Saints
Human souls elevated by concentrated faith. Each bound by the nature of their sainthood.

- **Role**: Champions, miracle-workers, assassins
- **Weakness**: Must follow their specific sacred laws
- **Status**: Deployed against high-value targets like Lilith

### Chosen Heroes
Regular humans elevated by God to serve as divine instruments.

- **Role**: Assassins sent after specific targets
- **Creation**: God grants them temporary divine power
- **Weakness**: Their power is borrowed; can be cut off
- **Status**: Sent repeatedly against Lilith; all have failed
...
### The Watchers
- **Nature**: Unknown — possibly ancient Aether beings predating God
- **Goals**: Observation; non-interference
- **Why Neutral**: Their existence predates human faith; they owe nothing to either side
- **Significance**: May hold knowledge Lilith needs

---

*Add factions as they appear in your story.*

*Cross-reference: [The War](the-war.md) | [Divine Law](divine-law.md) | [Characters](characters.md)*

...
- A new element
- A reality-binding field
- A substance that reacts directly to human thought, belief, and intent

**It behaves like electricity... but is shaped by consciousness.**

## The Debate

| Religion Says | Science Says |
|---------------|--------------|
| Aether is divine | Aether is undiscovered physics |
| Proof of God | Proof of consciousness as a physical force |

**Both are technically correct.**

## The Real Truth

When billions of minds believed in gods, angels, and miracles over centuries, Aether condensed around those beliefs.
...
God is not the creator. God is the largest Aether thought-form ever created — a self-sustaining parasitic intelligence born from:
- Fear
- Worship
- Hope
- Desperation
...
- Stronger emotions = stronger Aether response
- Range of influence depends on user's ability tier
- Individual will vs. collective belief: collective is stronger but slower

### Ability Tiers
| Tier | Description | Population % |
|------|-------------|--------------|
| Baseline | Minimal sensitivity | ~85% |
| Elevated | Occasional intuition, minor effects | ~10% |
| Significant | Clear manipulation potential | ~4% |
| Exceptional | Rare, powerful abilities | ~0.9% |
| Anomalous | Off-scale readings | <0.1% |

**Lilith Blackwell is Anomalous-tier.**

### The Feedback Loop
```
Faith → Aether condensation → Miracles → More faith → More Aether
```

Lilith's discovery: Prayer density, Aether resonance, miracle output, and angel casualty rates all correlate perfectly.

---

## Weaponization

The United States recognized Aether's military potential immediately.

### Key Applications
- **Ley-line grids**: Natural Aether channels converted to infrastructure
- **Soul-binding**: Human souls as power sources
- **Divine harvesting**: Reverse-engineering angels into batteries
- **Reality manipulation**: Sanctification bombs that break existence itself

See: [Technology](technology.md) for full weapons catalog.
...
*Cross-reference: [Divine Law](divine-law.md) | [Technology](technology.md)*

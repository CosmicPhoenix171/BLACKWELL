...
Any US citizen who displays **higher than normal Aether abilities** is:
1. Identified through mandatory Aether screening (disguised as routine medical tests)
2. Flagged in a classified database
3. Approached by "recruiters" — refusal is not an option
4. Drafted into AETHCOM regardless of age, career, or circumstances

**You don't volunteer for AETHCOM. AETHCOM takes you.**

### Aether Ability Tiers

| Tier | Description | Fate |
|------|-------------|------|
| Baseline | Normal human, minimal Aether sensitivity | Civilian life |
...
| Division | Role |
|----------|------|
| Acquisitions | "Recruiting" new Aether-capable individuals |
| Research & Development | Aether-tech weapons, implants, systems |
...
- Black sites internationally
- Mobile command carriers (the "magic aircraft carriers")
- Dimensional staging areas
...
|------------|-------------|
| Ley-line power grids | Natural Aether channels converted to infrastructure |
| Soul-bound weapons | Human souls imprisoned as power sources |
| Thought-controlled spell processors | Mental interface combat systems |
| Angel batteries | Divine beings reverse-engineered into energy cells |
| Prayer artillery | Collective belief converted into destructive force |
| Magic aircraft carriers | AETHCOM mobile bases, dimensionally shielded |
| Dimensional strike portals | Instant force projection anywhere on Earth |
| Reality-rewriting sanctification bombs | Target ceases to exist *correctly* |
